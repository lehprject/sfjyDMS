...
namespace Model
{
    ...
    {
        public string TableParm { get; set; }

        public string ColumnParm { get; set; }

        public string WhereParm { get; set; }

        public string OrderParm { get; set; }

        public int PageSizeParm { get; set; }

        public int PageIndexParm { get; set; }

        public int RecordParm { get; set; }
    }
    /// <summary>
    /// MySqlHelper操作类
    /// </summary>
    public sealed partial class MySqlHelper
    {
        ...
        public MySqlHelper()
        {
            ...
            if (ConfigurationManager.ConnectionStrings["MysqlConnStr"] != null)
            {
                this.ConnectionString = ConfigurationManager.ConnectionStrings["MysqlConnStr"].ConnectionString.ToString();
            }
        ...
        public MySqlHelper(string connstr)
        {
            ...
            {
                this.ConnectionString = ConfigurationManager.ConnectionStrings[connstr].ConnectionString.ToString();
            }
        ...
        /// <param name="columns">操作的字段，多个字段用逗号,分割</param>
        /// <param name="values">操作的字段对应的值，多个字段用逗号,分割</param>
        public void InsertMethod(string tablename, string columns, string values)
        {
            ...
            var arr = parms.ToArray();
            int rows = ExecuteNonQuery(sql.ToString(), arr);
        }
        #endregion
    }
}
